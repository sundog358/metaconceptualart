...
const ROUTES = [
  ...
  ["modeling.html", "The Website Is A DigitalObject"],
  ["bibliography.html", "External Sources And Reception"],
  ...
  ["artworks/wtfisart.html", "Sotheby"],
